...
// protégé par un jeton. Appelé automatiquement par GitHub Actions après le déploiement SFTP.
//
// install.sql est écrit pour être rejoué sans risque : CREATE TABLE IF NOT EXISTS pour les
// tables, procédures conditionnelles (information_schema) pour les colonnes, CREATE OR REPLACE
// pour les vues. Aucune donnée existante n'est écrasée.
...
// Les lignes DELIMITER et les lignes de commentaire pur (--) ne sont pas envoyées au serveur.
